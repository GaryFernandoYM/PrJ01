...
public class ClientesJDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        v_tipo_a = new javax.swing.JRadioButton();
        v_tipo_b = new javax.swing.JRadioButton();
        ...
        v_nombre.setBackground(new java.awt.Color(255, 102, 102));
        ...
        v_paterno.setBackground(new java.awt.Color(255, 102, 102));

        v_materno.setBackground(new java.awt.Color(255, 102, 102));
        ...
        v_codigo.setBackground(new java.awt.Color(255, 102, 102));
        ...
        v_usuario.setBackground(new java.awt.Color(255, 102, 204));

        v_contrasenia.setBackground(new java.awt.Color(255, 102, 204));
        ...
        buttonGroupTipoCliente.add(v_tipo_a);
        v_tipo_a.setText("A");
        v_tipo_a.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                v_tipo_aActionPerformed(evt);
            }
        });

        buttonGroupTipoCliente.add(v_tipo_b);
        v_tipo_b.setText("B");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(v_tipo_a)
                                .addGap(18, 18, 18)
                                .addComponent(v_tipo_b))
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
    ...
    private void jButtonGrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGrabarActionPerformed
        Cliente dp= new Cliente();
                        ...
                        if(v_tipo_a.isSelected()==true){  
                        dp.setCliente_tipo("A");
                        }
                        if(v_tipo_b.isSelected()==true){  
                        dp.setCliente_tipo("B");
                        } 
    ...
    private void v_tipo_aActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_v_tipo_aActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_v_tipo_aActionPerformed
    ...
    private javax.swing.JRadioButton v_tipo_a;
    private javax.swing.JRadioButton v_tipo_b;
